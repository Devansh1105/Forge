...
from forge import __version__ as FORGE_KERNEL_VERSION
...
class BenchmarkData:
    ...
    forge_version: str = FORGE_KERNEL_VERSION
...
def run_benchmarks(
    ...
    Args:
        ...
        - kernel_providers: The list of kernel providers to run the benchmark on (e.g. ["forge", "huggingface"])
        ...
        for kernel_operation_mode in kernel_operation_modes:
            for kernel_provider in kernel_providers:
                ...
                benchmark_run_data = BenchmarkData(
                    ...
                    forge_version=FORGE_KERNEL_VERSION,
                )
...
def parse_benchmark_script_args():
    parser = argparse.ArgumentParser(description="Benchmarking script for Forge-Kernel")
