...
Suggested commands from the repo root:
...
4. Keep admin access limited to one or two maintainers.
...
Start with lightweight style CI. Add GPU correctness and benchmark CI later on a
self-hosted A100/H100 runner.
